...
import com.sachet.signupflow.databinding.FragmentSignUpPageBinding
...
class SignUpPageFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val bundles = requireArguments()
        val name = bundles.get("user_name_input")
        val email = bundles.get("user_email")
